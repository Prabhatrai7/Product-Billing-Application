	...
	public Product getProductDetails(int product_code) {
		...
		return jdbcTemplate.queryForObject(query, new Object[] { product_code }, new RowMapper<Product>() {
			...
			public Product mapRow(ResultSet rs, int rowNum) throws SQLException {
				return new Product(rs.getInt("product_code"), rs.getString("product_name"), rs.getString("product_category"), rs.getString("product_desc"), rs.getDouble("product_price"));
			}
		});
	}
}
